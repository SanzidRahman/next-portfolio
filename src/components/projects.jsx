...
function Project ({title,description,tags,imageUrl}){
    return (
    <section className="-z-10 bg-slate-100  max-w-[42rem] border border-gray-300 mb-2 relative overflow-hidden h-[20rem] flex sm:rounded-full group  ">
    ...
    <h1 className="text-2xl mt-3 mb-3 ">{title}</h1>
      ...
      <Image
        ...
        priority={true}
        quality={95}
        className="h-[300px] w-[300px] absolute top-8 -right-[50px] object-cover"
     />
      </div>
